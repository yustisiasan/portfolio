                          ...
                          foreach ($roadmap as $key) {
                              echo '
                                <tr>
                                  ...
                                  <td>'.$key["nip"].'</td>
                                  <td>'.$key["nama"].'</td>
                                  <td>'.$key["penelitian_unggulan"].'</td>
                                  <td>'.$key["bidang_penelitian"].'</td>
                                  <td>'.$key["email"].'</td>
                                  <td>'.$key["no_telp"].'</td>
                                  <td><a href="'.base_url().'c_roadmap/detailRoadmap/'.$key["id_dosen"].'" class="btn btn-success btn-xs"><i class="fa fa-eye"></i> Lihat</a></td>
                                </tr>
                              ';
