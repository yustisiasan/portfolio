          ...
          <div class="">
            <div class="page-title">
               <div class="title_left">
                <h3>Daftar Ketua Keloampok Keahlian</h3>
               </div>
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <ul class="nav navbar-right panel_toolbox">
                      <li class="dropdown">
                        <a href="<?php echo base_url();?>c_register/tambahKetua"><i class="fa fa-plus-circle"></i> Tambah Ketua KK</a>
                      </li>
